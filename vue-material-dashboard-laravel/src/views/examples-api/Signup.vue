                        ...
                        <div class="row">
                            ...
                            <div
                                ...
                                <div class="card card-plain">
                                    ...
                                    <div class="card-body">
                                        <SignupForm role="form" :validation-schema="schema" @submit="handleSignup">
                                            <div class="mb-3">
...
import { Form as SignupForm } from "vee-validate";  // Updated import to use SignupForm
...
export default {
    ...
    components: {
        ...
        MaterialButton,
        SignupForm,  // Updated component registration
    },
    data() {
        return {
            user: [],
