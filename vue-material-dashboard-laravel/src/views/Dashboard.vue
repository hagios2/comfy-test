        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <mini-statistics-card
              :title="{ text: 'Total Policies', value: stats.active_policies }"
              detail=" Only Active Polices"
              :icon="{
                name: 'books',
                color: 'text-white',
                background: 'primary',
...
<!--                 detail="<span class='text-success text-sm font-weight-bolder'>+3%</span> than last month"-->
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card
              :title="{ text: 'Close Expires', value: stats.expiring_policies_count }"
              detail="Expiring in <span class='text-danger text-sm font-weight-bolder'>30 days</span> "
              :icon="{
                name: 'schedule',
                color: 'text-white',
                background: 'danger',
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card
              :title="{ text: 'Total Customers', value: stats.customers_count }"
              detail="Onboarded Customers"
              :icon="{
                name: 'people',
                color: 'text-white',
                background: 'info',
