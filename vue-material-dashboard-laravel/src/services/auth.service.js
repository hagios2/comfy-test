...
export default {
  ...
  async login(user) {
    var response = await axios.post(API_URL + '/v2/login', {
      email: user.email,
  ...
  async register(user) {
    var response = await axios.post(API_URL + '/v2/register', {
      name: user.name,
      email: user.email,
      password: user.password,
  ...
  async passwordForgot(userEmail) {
    ...
    var response = await axios.post(API_URL + '/v2/password-forgot', {
  ...
  async passwordReset(passwordDTO) {
    ...
    var response = await axios.post(API_URL + '/v2/password-reset', {
